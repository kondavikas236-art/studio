...
import { Sparkles, Send, RotateCcw, PartyPopper } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="text-center space-y-2">
        <h1 className="text-4xl font-black text-primary">Story Chain</h1>
        <p className="text-muted-foreground font-medium">Create a masterpiece with your AI Buddy!</p>
      </div>
          ...
          <ScrollArea className="h-[400px] p-8">
            {!story ? (
              <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
                ...
                <h2 className="text-2xl font-bold">Ready to write a legend?</h2>
              ...
              <div className="space-y-4 whitespace-pre-wrap leading-relaxed font-medium">
                ...
                {isComplete && (
                  <div className="bg-accent/20 p-6 rounded-3xl mt-8 flex flex-col items-center text-center space-y-3">
                    ...
                    <p className="text-sm">Wow! What an incredible journey we wrote together.</p>
