    ...
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      ...
      <Alert className="bg-primary/5 border-primary/20 rounded-2xl print:hidden">
        ...
        <AlertDescription className="text-sm">
          Background monitoring and Cockroach mode are simulated. Reports are generated by Gemini AI.
        </AlertDescription>
      </Alert>
      ...
      <div className="grid gap-6 print:hidden">
        ...
        <Card className="rounded-3xl border-none shadow-sm border-l-4 border-l-destructive overflow-hidden">
          <CardHeader>
            ...
            <CardDescription>Trigger visual deterrents when Health Break time is reached.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
      ...
      <Dialog open={!!testReport} onOpenChange={() => setTestReport(null)}>
        <DialogContent className="rounded-[3rem] max-w-4xl max-h-[90vh] overflow-hidden flex flex-col p-0 border-none shadow-2xl">
          <DialogHeader className="p-8 pb-4 bg-primary text-white print-hidden">
            ...
            <DialogDescription className="text-white/80 font-medium">Generated by Kidsyee AI</DialogDescription>
          </DialogHeader>
            ...
            <div id="pdf-report" className="bg-white p-10 rounded-[2.5rem] border shadow-sm space-y-8 text-foreground max-w-3xl mx-auto">
              <div className="flex justify-between items-center border-b pb-6">
                <div>
                  ...
                  <p className="text-xs font-black uppercase text-muted-foreground tracking-widest mt-1">Consolidated Family Insight</p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="whitespace-pre-wrap text-sm leading-relaxed p-6 bg-muted/20 rounded-3xl border-2 border-dashed border-muted">
                  {testReport?.formal}
                </div>
              </div>

              <div className="pt-8 border-t flex flex-col items-center gap-2 text-center">
                <div className="bg-accent/10 px-4 py-1 rounded-full text-accent-foreground font-black text-[10px] uppercase tracking-widest">
                  Powered by Kidsyee AI
                </div>
          ...
          <div className="p-6 border-t bg-white flex justify-center print:hidden">
             <Button onClick={() => setTestReport(null)} variant="ghost" className="rounded-full font-bold text-muted-foreground">Close Preview</Button>
          </div>
        </DialogContent>
      </Dialog>
    </div>
