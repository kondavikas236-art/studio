          ...
          <ScrollArea className="flex-1 p-8 bg-[#F8FAFC]">
            <div id="pdf-report" className="bg-white p-10 rounded-[2.5rem] border shadow-sm space-y-8 text-foreground max-w-3xl mx-auto">
              ...
              {testReport?.chartData && testReport.chartData.length > 0 && (
                <div className="space-y-4">
                  <h2 className="text-xl font-black flex items-center gap-2">
                    <PieChartIcon className="h-5 w-5 text-primary" /> Consolidated Screen Time Distribution
                  </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="whitespace-pre-wrap text-sm leading-relaxed p-6 bg-muted/10 rounded-3xl border border-muted">
                  {testReport?.formal}
                </div>
              </div>

              <div className="pt-8 border-t flex flex-col items-center gap-2 text-center">
                <Badge className="bg-accent/10 text-accent-foreground font-black text-[10px] px-3 py-1">
